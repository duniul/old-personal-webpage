        ...
        return (
            <React.Fragment>
                ...
                <div className={`presentation-text ${tldr ? 'tldr' : ''}`}>
                    <p>
                        Well, during my time at Com Hem I built a <Highlight color="pink">web based, in-house CRM-system</Highlight> from{' '}
                        scratch, together with four other people. It's a modern, fast SPA built with React.js, Java and Oracle. The system has been my primary focus at work.
                    </p>
                    <p>
                        I have also been a part of several hackathons and side projects at Com Hem. Together with some colleagues I{' '}
                        built an online, <Highlight color="orange">interactive map</Highlight> of the company office to help new and/or confused{' '}
                        employees find their way around. We also created a <Highlight color="orange">web service</Highlight> for customers to{' '}
                        <Highlight color="orange">easily configure modems</Highlight>, skipping the hazzle of having to manually log into it.
                    </p>
                    <p>
                    ...
                    <p>
                        Finally, there's <Highlight color="blue" url={URLS.GRONSTRAND_COM_GITHUB}>this website</Highlight>.{' '}
            ...
            <React.Fragment>
                ...
                <div className={`presentation-text ${tldr ? 'tldr' : ''}`}>
                    <p>
                        ...
                        I usually don't release them, but I made some mods for Fallout 4 that I thought could
                        be useful to others.
                    </p>

                    <p>
                        The most popular one is <Highlight color="teal" url={URLS.CRAFTING_WORKBENCHES}>Crafting Workbenches</Highlight>, which allows players{' '}
                        to <Highlight color="teal">craft items</Highlight> from mater&shy;ials. It also serves as{' '}
                        a <Highlight color="teal">plat&shy;form for modders</Highlight> to make their own creations{' '}
                        craft&shy;able in the game. It is currently in the top 30 of the most endorsed Fallout 4 mods{' '}
                        of all time, with over a <Highlight color="teal">million downloads</Highlight>.{' '}
                    </p>

                    <p>
                        <Highlight color="pink" url={URLS.AWKCR}>AWKCR</Highlight>{' '}
                        is a <Highlight color="pink">frame&shy;work to help modders</Highlight> make{' '}
                        their creations compatible with each other. I joined the project in the early stages{' '}
                        and <Highlight color="pink">contributed code</Highlight> from Crafting Workbenches.{' '}
                        I also created many of its community patches. It is currently the <Highlight color="pink">most downloaded</Highlight>{' '}
                        Fallout 4 mod of all time.
                    </p>

                    <p>
                        I also created a number of <Highlight color="orange">smaller mods</Highlight>.{' '}
                        One lets players <Highlight color="orange" url={URLS.COMPANION_TRACKING}>track companions</Highlight>,{' '}
                        a feature which was later adopted by the game developers themselves.{' '}
                        Another one allows players to <Highlight color="orange" url={URLS.SETTLER_RENAMING}>rename characters</Highlight> in{' '}
                        the game using simple batch commands. Finally, one lets players <Highlight color="orange" url={URLS.VOT}>aim great distances</Highlight> with{' '}
    ...
    renderIntroPage = () => {
        ...
        return (
            <React.Fragment>
                ...
                <div className={`presentation-text ${tldr ? 'tldr' : ''}`}>
                    <p>
                        A <Highlight color="blue">Swedish</Highlight> man who likes to tinker with things, like code, hard&shy;ware or Legos.
                        I currently work as a <Highlight color="blue">full-stack developer</Highlight> at Com Hem, in <Highlight color="blue">Stockholm</Highlight>.
                    </p>
                    <p>
                        I love to create things and challenge myself, like trying out odd new programming languages, even though I am
                        most <Highlight color="orange">proficient in</Highlight> main&shy;stream languages
                        like <Highlight color="orange">JavaScript</Highlight> and <Highlight color="orange">Java</Highlight>.
                    </p>
                    <p>
                        I am also an avid <Highlight color="teal">gamer</Highlight>, and have <Highlight color="teal">dabbled in game modding</Highlight> as a
                        hobby. I published a couple of the ones I made for Fallout 4, and they now have over a <Highlight color="teal">million downloads</Highlight> and
                        counting.
                    </p>
                </div>
            </React.Fragment>
